                ...
                <div className="container-fluid pt-5 landingPage">
                        <div className="row">
                            <div className="col-md-6" id="texthome">
                                <h1><b>Sewa dan Rental Mobil Terbaik di kawasan Semarang</b></h1>
          ...
          <div className="row align-items-center g-1">
            ...
            <div className="col-md-6 mt-md-5">
              <div id="textService" className="my-md-5 mr-1">
                <h2><b>Best Car Rental for any kind of trip in Semarang!</b></h2>
      ...
      <div className="my-5 container">
        <div className="row py-lg-5">
          ...
          <div className="konten5 text-center">
            <h2 className="textkonten5 mb-3"><b>Sewa Mobil di Semarang Sekarang!</b></h2>
